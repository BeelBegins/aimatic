"""Attach S4 orphan Barcode2 onto the already-matched Item (siezal mock).
...
barcode rows/UOMs. New row copies UOM from that item's existing barcode rows.
    ...
    ns={}
    path="/home/nabeel/frappe-bench/apps/aimatic/ipos_data_migration/attach_s4_orphan_barcode2.py"
