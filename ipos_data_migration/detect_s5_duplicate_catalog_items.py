"""Read-only: find S5 rows whose Barcode1/Barcode2 resolve to two different
...
Run against siezal (mock, already has the 4,883 new S5 Items) or szl.

    ns={}
    path="/home/nabeel/frappe-bench/apps/aimatic/ipos_data_migration/detect_s5_duplicate_catalog_items.py"
