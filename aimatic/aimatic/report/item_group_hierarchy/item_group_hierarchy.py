...
def get_columns():
    return [
        ...
        {"label": _("Loyalty Rate Configured"), "fieldname": "loyalty_rate_configured", "fieldtype": "Data", "width": 130},
        {"label": _("Loyalty Points per Rs 100"), "fieldname": "loyalty_points_rate", "fieldtype": "Float", "width": 150},
        {"label": _("Effective Loyalty Points per Rs 100"), "fieldname": "effective_loyalty_points_rate", "fieldtype": "Float", "width": 180},
    ]
