...
_DOC_SPECIFIC_DENY = frozenset({
    ...
    "docstatus", "owner", "creation", "modified", "modified_by", "doctype",
    # quantity - rule 1, plus inherently doc-specific
    "qty", "stock_qty", "uom", "stock_uom", "conversion_factor", "stock_uom_rate",
    "received_qty", "rejected_qty", "returned_qty", "billed_amt",
    # rate/amount - rule 1, plus everything core ERPNext derives from it
    "rate", "amount", "price_list_rate", "base_rate", "base_amount",
    "base_net_rate", "base_net_amount", "net_rate", "net_amount",
    ...
    "warehouse", "rejected_warehouse", "from_warehouse", "t_warehouse", "s_warehouse",
    "cost_center", "project", "branch",
    "batch_no", "serial_no", "serial_and_batch_bundle",
    "expense_account", "item_tax_template", "weight_per_unit", "total_weight", "weight_uom",
    "purchase_order", "purchase_order_item", "material_request", "material_request_item",
    "sales_order", "sales_order_item", "subcontracted_item", "bom", "include_exploded_items",
    "allow_zero_valuation_rate", "landed_cost_voucher_amount", "rm_supp_cost",
    "asset_location", "asset_category", "quality_inspection", "putaway_rule",
    "manufacturer", "manufacturer_part_no", "brand", "item_group", "page_break", "barcode",
    "is_free_item", "retain_sample", "sample_quantity",
})
...
_COMPUTED_OUTPUT_DENY = frozenset({
    "custom_price_after_taxes", "custom_price_without_taxes", "custom_old_price_after_tax",
    "custom_discount_amnt", "custom_advance_tax_amount", "custom_gst_amount", "custom_fed_amount",
    "custom_trade_offer_total", "custom_gross_total", "custom_line_total", "custom_base_cost_price",
