...
_CAPABILITIES = (
	...
	_capability("company_foundation", "Company and chart of accounts", "Foundation", "standard", "ERP company, currency, chart of accounts, and control accounts form the accounting base.", "Complete Company defaults and use active leaf accounts for posting.", critical=True, check_key="company", route="List/Company"),
	...
	_capability("inventory_valuation", "Inventory valuation", "Inventory", "standard", "ERP Stock Ledger and valuation settings provide forward inventory value.", "Maintain stock reconciliation and never infer unavailable pre-cutover movement history.", check_key="inventory", route="query-report/Stock Balance"),
	...
	_capability("supplier_payables", "Supplier payables", "Working Capital", "standard", "ERP payable ledgers and ageing provide supplier outstanding balances.", "Reconcile supplier opening balances and future invoices/payments to the payable control account.", check_key="receivables_payables", route="query-report/Accounts Payable"),
	_capability("customer_receivables", "Customer receivables (B2B)", "Working Capital", "standard", "ERP receivable ledgers and ageing provide customer outstanding balances.", "Use credit customers and reconcile invoices, receipts, and opening balances to the receivable control account.", check_key="receivables_payables", route="query-report/Accounts Receivable"),
	_capability("bank_reconciliation", "Bank reconciliation", "Treasury", "standard", "ERP Bank Transaction and Bank Reconciliation provide statement matching.", "Import bank statements and complete matching at an agreed daily or weekly cadence.", check_key="cash_bank", route="List/Bank Transaction"),
	...
	_capability("budget_vs_actual", "Budget vs actual", "Planning", "standard", "ERP budgets support cost-center and accounting-dimension controls.", "Enter approved budgets by fiscal year and ownership level before relying on variance reporting.", check_key="reporting", route="List/Budget"),
	_capability("consolidated_financial_statements", "Consolidated financial statements", "Management Reporting", "standard", "ERP supports consolidated statements across configured company trees.", "This becomes testable when additional legal entities or group companies exist.", check_key="company", route="query-report/Consolidated Financial Statement"),
