...
TOOL_SPECS = _CORE_SPECS + _EXTENDED_SPECS + _ACCOUNTS_SPECS + _EXPANDED_SPECS + _REPORT_RUNNER_SPECS + _ANALYTICS_SPECS + _DYNAMIC_REPORT_SPECS + _ABC_XYZ_SPECS + _FORECAST_SPECS
TOOL_DISPATCH = {**_CORE_DISPATCH, **_EXTENDED_DISPATCH, **_ACCOUNTS_DISPATCH, **_EXPANDED_DISPATCH, **_REPORT_RUNNER_DISPATCH, **_ANALYTICS_DISPATCH, **DYNAMIC_REPORT_DISPATCH, **_ABC_XYZ_DISPATCH, **_FORECAST_DISPATCH}
