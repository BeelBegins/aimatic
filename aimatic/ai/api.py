...
from aimatic.ai.demand_forecasting import TOOL_DISPATCH as _FORECAST_DISPATCH, TOOL_SPECS as _FORECAST_SPECS
from aimatic.ai.price_recommendation import TOOL_DISPATCH as _PRICE_DISPATCH, TOOL_SPECS as _PRICE_SPECS
from aimatic.ai.advanced_intelligence_tools import TOOL_DISPATCH as _ADVANCED_BI_DISPATCH, TOOL_SPECS as _ADVANCED_BI_SPECS
...
TOOL_SPECS = _CORE_SPECS + _EXTENDED_SPECS + _ACCOUNTS_SPECS + _EXPANDED_SPECS + _REPORT_RUNNER_SPECS + _ANALYTICS_SPECS + _DYNAMIC_REPORT_SPECS + _ABC_XYZ_SPECS + _FORECAST_SPECS + _PRICE_SPECS + _ADVANCED_BI_SPECS
TOOL_DISPATCH = {**_CORE_DISPATCH, **_EXTENDED_DISPATCH, **_ACCOUNTS_DISPATCH, **_EXPANDED_DISPATCH, **_REPORT_RUNNER_DISPATCH, **_ANALYTICS_DISPATCH, **DYNAMIC_REPORT_DISPATCH, **_ABC_XYZ_DISPATCH, **_FORECAST_DISPATCH, **_PRICE_DISPATCH, **_ADVANCED_BI_DISPATCH}
