...
def list_frappe_reports(keyword: str | None = None, limit: int = 20) -> dict:
	...
	return {
		"reports": [{"report_name": ds.name, "description": ds.description} for ds in reports[:limit]],
		...
		"function": {
			...
			"parameters": {
				...
				"properties": {
					"keyword": {
						"type": "string",
						"description": 'Keyword(s) to search report names/descriptions for, e.g. "stock balance" or "accounts receivable".',
					},
		...
		"function": {
			...
			"parameters": {
				...
				"properties": {
					"report_name": {
						"type": "string",
						"description": "Exact report name, as returned by list_frappe_reports.",
					},
					"filters": {
						"type": "object",
						"description": 'Filter values to pass to the report, e.g. {"from_date": "2026-07-01", "to_date": "2026-07-31"}. Company is always forced server-side regardless of this.',
					},
