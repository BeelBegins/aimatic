...
TOOL_REGISTRY: dict[str, DataSource] = {
    ...
    "get_trial_balance_summary": DataSource(
        ...
        source_type="tool",
        supported_filters=["date_from", "date_to"],
        returned_fields=["asset_balance", "liability_balance", "equity_balance", "income_balance", "expense_balance", "balance_check"],
        example_questions=[
    ...
    "get_branch_profit_and_loss": DataSource(
        ...
        example_questions=["Which branch is most profitable?", "Show me profit and loss by branch", "How does branch performance compare in net profit?"],
        supported_visualizations=["kpi", "table", "chart"],
    ),
    "get_sales_trend": DataSource(
        ...
        example_questions=["Show me the sales trend for the last 3 months", "How have weekly sales moved this quarter?"],
        branch_scoped=True,
        estimated_cost="low",
    ),
    ...
    "get_supplier_price_comparison": DataSource(
        ...
        example_questions=["Which supplier gives us the best price on this item?", "Compare purchase rates across suppliers for item X"],
        branch_scoped=True,
        estimated_cost="low",
    ),
    "get_po_receipt_variance": DataSource(
        ...
        supported_visualizations=["table"],
        example_questions=["Which suppliers short-deliver on our orders?", "Show ordered vs received quantity variance"],
        branch_scoped=True,
        estimated_cost="low",
    ),
    ...
    "get_stock_aging": DataSource(
        ...
        returned_fields=["items"],
        supported_visualizations=["table", "chart"],
        example_questions=["How old is our stock on hand?", "Show items that haven't been restocked recently"],
        branch_scoped=True,
        estimated_cost="trivial",
    ),
    ...
    "get_open_documents_overview": DataSource(
        ...
        supported_visualizations=["kpi", "table"],
        example_questions=["Do we have unsubmitted documents piling up?", "Which shifts have been open too long?"],
        branch_scoped=True,
        estimated_cost="low",
    ),
    "run_analytics_query": DataSource(
        ...
        source_type="tool",
        supported_filters=["dataset", "measures", "dimension", "branch", "supplier", "date_from", "date_to", "sort", "limit", "compare_previous_period"],
        returned_fields=["rows", "row_count"],
        supported_visualizations=["kpi", "table", "chart"],
        example_questions=["Compare net sales by branch this month vs last month", "Show outstanding payable by aging bucket"],
        branch_scoped=True,
        estimated_cost="low",
    ),
    "drill_down_transactions": DataSource(
        ...
        source_type="tool",
        supported_filters=["dataset", "branch", "supplier", "customer", "item_code", "warehouse", "date_from", "date_to", "limit"],
        returned_fields=["rows"],
        supported_visualizations=["table"],
        example_questions=["Show me the invoices behind this branch's sales decline", "Which vouchers make up this supplier's balance?"],
        branch_scoped=True,
        estimated_cost="low",
    ),
    ...
    "run_frappe_report": DataSource(
        ...
        supported_visualizations=["table"],
        example_questions=["Run the Stock Balance report", "Show Accounts Receivable from the standard report"],
        branch_scoped=False,
