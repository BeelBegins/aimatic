...
def check_alert_rules():
    ...
    RULE_MAP = {
        ...
        "branch_underperformance": (get_branch_comparison, _detect_branch_underperformance, "get_branch_comparison"),
        "low_gross_margin": (get_gross_margin_overview, _detect_low_gross_margin, "get_gross_margin_overview"),
        "payables_concentration": (get_outstanding_payables_overview, _detect_payables_concentration, "get_outstanding_payables_overview"),
