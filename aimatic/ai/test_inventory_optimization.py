...
class TestInventoryTransfers(TestCase):
	def test_surplus_is_matched_to_deficit_without_double_allocation(self):
		positions = [
			{"item_code": "A", "item_name": "A", "branch": "North", "warehouse": "N", "stock_quantity": 100, "daily_demand": 1, "valuation_rate": 10, "active_days": 30},
			{"item_code": "A", "item_name": "A", "branch": "South", "warehouse": "S", "stock_quantity": 0, "daily_demand": 2, "valuation_rate": 10, "active_days": 30},
			{"item_code": "A", "item_name": "A", "branch": "East", "warehouse": "E", "stock_quantity": 0, "daily_demand": 1, "valuation_rate": 10, "active_days": 30},
		]
